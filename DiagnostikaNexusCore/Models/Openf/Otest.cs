...
{
    public partial class Otest
    {
        public Otest()
        {
            Oltest = new HashSet<Oltest>();
            Oprecio = new HashSet<Oprecio>();
            OproyectoParamMemberNavigation = new HashSet<Oproyecto>();
            OproyectoParamOwnerNavigation = new HashSet<Oproyecto>();
            Orango = new HashSet<Orango>();
            Qt = new HashSet<Qt>();
        }
        ...
        public string PlantillaACod { get; set; }
        public string PlantillaBCod { get; set; }
        public short? PlantillaBElid { get; set; }
        public short? PlantillaBSelid { get; set; }
        public string PlantillaECod { get; set; }
        ...
        public virtual ICollection<Oprecio> Oprecio { get; set; }
        public virtual ICollection<Oproyecto> OproyectoParamMemberNavigation { get; set; }
        public virtual ICollection<Oproyecto> OproyectoParamOwnerNavigation { get; set; }
        public virtual ICollection<Orango> Orango { get; set; }
