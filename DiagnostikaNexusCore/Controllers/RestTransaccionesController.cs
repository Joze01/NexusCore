...
namespace DiagnostikaNexusCore.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class RestTransaccionesController : ControllerBase
    {
        private readonly hl7Context _context;

        public RestTransaccionesController(hl7Context context)
        {
            _context = context;
        }

        // GET: api/RestTransacciones
        [HttpGet]
        ...
        // DELETE: api/RestTransacciones/5
        [HttpDelete("{id}")]
