...
namespace DiagnostikaNexusCore.DOT.Hl7Response
{
    public class OBR
    {
        ...
        private OBXHeader oBXHeader;
        private List<OBXBody> oBXBodyList;
        ...
        public OBXHeader OBXHeader { get => oBXHeader; set => oBXHeader = value; }
        public List<OBXBody> OBXBodyList { get => oBXBodyList; set => oBXBodyList = value; }
    }
}
